...
gdjs.evtsExt__SwipeGesture__IsSwipeDetectionEnabled.conditionTrue_0 = {val:false};
gdjs.evtsExt__SwipeGesture__IsSwipeDetectionEnabled.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__SwipeGesture__IsSwipeDetectionEnabled.condition1IsTrue_0 = {val:false};
...
gdjs.evtsExt__SwipeGesture__IsSwipeDetectionEnabled.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__SwipeGesture__IsSwipeDetectionEnabled.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getScene().getVariables().get("__SwipeGesture").getChild("Enabled"), true);
}if (gdjs.evtsExt__SwipeGesture__IsSwipeDetectionEnabled.condition0IsTrue_0.val) {
