...
gdjs.evtsExt__YGameSDK__IsInitLeaderboard.conditionTrue_0 = {val:false};
gdjs.evtsExt__YGameSDK__IsInitLeaderboard.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__YGameSDK__IsInitLeaderboard.condition1IsTrue_0 = {val:false};
...
gdjs.evtsExt__YGameSDK__IsInitLeaderboard.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__YGameSDK__IsInitLeaderboard.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getGame().getVariables().get("YGSDK_IsInit_Leaderboard"), true);
}if (gdjs.evtsExt__YGameSDK__IsInitLeaderboard.condition0IsTrue_0.val) {
...
gdjs.evtsExt__YGameSDK__IsInitLeaderboard.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__YGameSDK__IsInitLeaderboard.condition0IsTrue_0.val = gdjs.evtsExt__YGameSDK__IsInit.func(runtimeScene, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}if (gdjs.evtsExt__YGameSDK__IsInitLeaderboard.condition0IsTrue_0.val) {
