...
gdjs.evtsExt__SwipeGesture__onScenePreEvents.conditionTrue_0 = {val:false};
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition1IsTrue_0 = {val:false};
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition2IsTrue_0 = {val:false};
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition3IsTrue_0 = {val:false};
gdjs.evtsExt__SwipeGesture__onScenePreEvents.conditionTrue_1 = {val:false};
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition0IsTrue_1 = {val:false};
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition1IsTrue_1 = {val:false};
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition2IsTrue_1 = {val:false};
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition3IsTrue_1 = {val:false};
...
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition1IsTrue_0.val = false;
{
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition0IsTrue_0.val = gdjs.evtsExt__SwipeGesture__IsSwipeInProgress.func(runtimeScene, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}if ( gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition0IsTrue_0.val ) {
{
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonReleased(runtimeScene, "Left");
}}
...
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition2IsTrue_0.val = false;
{
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition0IsTrue_0.val = gdjs.evtsExt__SwipeGesture__IsSwipeDetectionEnabled.func(runtimeScene, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}if ( gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition0IsTrue_0.val ) {
{
gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonPressed(runtimeScene, "Left");
}if ( gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition1IsTrue_0.val ) {
{
...
gdjs.evtsExt__SwipeGesture__onScenePreEvents.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(12254820);
}
}}
}
if (gdjs.evtsExt__SwipeGesture__onScenePreEvents.condition2IsTrue_0.val) {
