...
gdjs.evtsExt__CrazyGamesAdApi__AdFinishedPlaying.conditionTrue_0 = {val:false};
gdjs.evtsExt__CrazyGamesAdApi__AdFinishedPlaying.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__CrazyGamesAdApi__AdFinishedPlaying.condition1IsTrue_0 = {val:false};
...
gdjs.evtsExt__CrazyGamesAdApi__AdFinishedPlaying.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__CrazyGamesAdApi__AdFinishedPlaying.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getScene().getVariables().get("__CrazyGamesExtension").getChild("adFinished"), true);
}if (gdjs.evtsExt__CrazyGamesAdApi__AdFinishedPlaying.condition0IsTrue_0.val) {
