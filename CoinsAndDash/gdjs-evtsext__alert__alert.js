...
gdjs.evtsExt__Alert__Alert.Alert.prototype.doStepPreEventsContext.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(12297540);
}
}}
...
gdjs.evtsExt__Alert__Alert.Alert.prototype.doStepPreEventsContext.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(12298572);
}
}}
}
