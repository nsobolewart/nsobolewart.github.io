...
gdjs.evtsExt__Alert__Alert.Alert.prototype.doStepPreEventsContext.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(11436380);
}
}}
...
gdjs.evtsExt__Alert__Alert.Alert.prototype.doStepPreEventsContext.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(11437412);
}
}}
}
