...
gdjs.evtsExt__Alert__Alert.Alert.prototype.doStepPreEventsContext.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(12307756);
}
}}
...
gdjs.evtsExt__Alert__Alert.Alert.prototype.doStepPreEventsContext.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(12308788);
}
}}
}
