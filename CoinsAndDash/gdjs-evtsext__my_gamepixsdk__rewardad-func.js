...
gdjs.evtsExt__My_GamePixSDK__RewardAd.userFunc0x72dfd0 = function(runtimeScene, eventsFunctionContext) {
"use strict";
window.GamePix.rewardAd().then(function (res) {
  var result = runtimeScene.getVariables().get("GamePixSDK_RewardedAdResult");
    if (res.success) {
...
gdjs.evtsExt__My_GamePixSDK__RewardAd.userFunc0x72dfd0(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
